      ...
      <div class="container_header phone_view border_top_bott">
        <div class="row">
          <div class="col-md-12 d-flex justify-content-between align-items-center">
            ...
            <div class="logo d-flex align-items-center justify-content-center"> <a href="javascript:void(0)"> <h4 style="margin-top: 10px;margin-left: 45px;">完成听课</h4><strong class="logo_icon">  </strong> <span class="logo-default"> </span> </a> </div>
		  ...
		  <div class="row">
			  <div class="col-md-12">
			    <div class="card">
			      ...
			      <div class="pull-in">
			        <form id="basic-form" action="{{url('admin/teval')}}" method="post" enctype="multipart/form-data">
			        	{{csrf_field()}}
			          <div>
			            <h3>基本课程信息</h3>
			            <section>
