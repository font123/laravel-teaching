  ...
  <div class="header-bg">
    <header class="main-header">
      <div class="container_header phone_view border_top_bott">
       ...
       <div class="" style="margin-left: 10px;"> <a href="{{url('admin/tperson')}}" ><img src="{{asset('resources/views/admin/style/img/back.png')}}" ></a> </div>
        ...
        <div class="content-bar"> 
          <div class="row"> 
            ...
            @foreach($data as $val)
			  ...
			  <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">用户名</span> <p contentEditable="true"  style="float: right;"><b>{{$val->teacher_name}}</b></p> </a>
			  </li>
			  <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">ID</span> <p contentEditable="true"   style="float: right;"><b>{{$val->teacher_id}}</b></p>   </a>
			  </li>
			    <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">所属学院</span><p  contentEditable="true"  style="float: right;"><b>{{$val->college}}</b></p>  </a>
			    </li>
				<li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">身份</span><p   contentEditable="true"  style="float: right;"><b>教师</b></p> </a>
				</li> 
				<li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">主教专业</span><p contentEditable="true"  style="float: right;"><b>{{$val->major}}</b></p> </a>
				</li>
			  </ul>
			  @endforeach
            </div>
