      ...
      <div class="container_header phone_view border_top_bott">
        <div class="row">
          <div class="col-md-12 d-flex justify-content-between align-items-center">
            ...
            <div class="logo d-flex align-items-center "><h4 style="margin-top: 10px;margin-left:25px;">选择听课</h4></div>
		...
		<div class="breadcrumbbar">
		  ...
		  <div class="row">
			...
			<div class="col-md-6 col-lg-6 col-xl-4">
			  ...
			  <form action="{{url('admin/nplan')}}" method="post">
       			 {{csrf_field()}}
			    ...
			    <div class="card m-b-30">
			      ...
			      <div class="card-body">
    	           ...
    	           <input class="hidden" name="stop" value="{{$val->stop}}">
    	            <input class="hidden" name="term" value="{{$val->term}}">
