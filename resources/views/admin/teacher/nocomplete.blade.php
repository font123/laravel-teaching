			 ...
			 <div class="page-header">
			  ...
			  <div class="col-md-6 col-lg-6 col-xl-4">
			   @if(session('msg'))
                ...
                @endif
			  @foreach($data as $val)
			 <form action="{{url('admin/tsign')}}" method="post">
			 {{csrf_field()}}
			  <ul id="lists" style="list-style: none;">
			    ...
			    <div class="card m-b-30">
			      ...
			      <button type="submit" class="btn btn-primary"><i class="feather socicon-zapier mr-2"></i>签到</button>
			       ...
			       <a href="{{url('admin/delete/'.$val->id)}}"><button type="button" class="btn btn-primary" id="btn" style="margin-left: 8px;"><i class="feather icon-send mr-2"></i>取消</button></a>
