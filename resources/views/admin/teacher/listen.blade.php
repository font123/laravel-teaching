        ...
        <div class="content-bar"> 
		 ...
		 <div class="col-md-6 col-lg-6 col-xl-3">
			   <div class="card text-white bg-primary m-b-30">
			     <div class="card-header">{{session('user.teacher_name')}}（老师）</div>
			     <div class="card-body">
           ...
           <div class="col-lg-12 col-xl-3">
			 ...
			 <a href="{{url('admin/tselects')}}">
			 <div class="card m-b-20">
			   <div class="card-body">			   
			     <div class="row align-items-center no-gutters">
			       <div class="col-8">
			         <p class="font-15">可选择听课课程</p>
			         <h4 class="card-title mb-0 border-0">{{$selectsum}}</h4>
			       </div>
			       <div class="col-4 text-right"><img src="{{asset('resources/views/admin/style/img/sele.png')}}" ></span> </div>
			     </div>
			   </div>
			 </div>
			 </a>
			  <a href="{{url('admin/nplan')}}">
             <div class="card m-b-20">
               <div class="card-body">
                 <div class="row align-items-center no-gutters">
                   <div class="col-8">
                     <p class="font-15">待听课</p>
			 ...
			 <a href="{{url('admin/teval')}}">
             <div class="card m-b-20">
               <div class="card-body">
                 <div class="row align-items-center no-gutters">
                   <div class="col-8">
                     <p class="font-15">待评教</p>
                     <h4 class="card-title mb-0 border-0">{{$nocom}}</h4>
                   </div>
			 ...
			 <a href="{{url('admin/yplan')}}">
             <div class="card m-b-20">
               <div class="card-body">
                 <div class="row align-items-center no-gutters">
                   <div class="col-8">
                     <p class="font-15">完成听课</p>
