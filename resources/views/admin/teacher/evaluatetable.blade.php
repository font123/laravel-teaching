...
<div id="dvLoading"></div>
	<form action="{{url('admin/yplan')}}" method="post">
				 {{csrf_field()}}
	         ...
	         <div class="row footer-bottom">
	             <div style="display: inline-block;" >
	             	<div style="margin-top:10px;margin-left:15px;">
	             		<a href="{{url('admin/teval')}}"><span class="iconfont icon-fanhui" style="font-size: 30px;color: #000;"></span></a>
	             	</div>
	             </div>
	            <div style="display: inline-block;margin-left: 45px;">
	            	<ul class="">
	            		  <div style="font-size: 24px;">同行评教</div>
	            	</ul>
	            </div>
    		...
    		document.getElementById("time").value = year+"/"+month2+"/"+day;
		      ...
		      function stars(size){
		       ...
		       if(index ===( scores[ i ] - 1)){
		    	...
		    	var etxt = document.getElementById("content").value;
