...
<!--            <div class="menu-icon"> <a href="javascript:void(0)" class="menu-toggler sidebar-toggler"></a> </div> -->
            <div class="logo d-flex align-items-center justify-content-center"> <a href="javascript:void(0)"> <h4 style="margin-top: 10px;margin-left: 65px;">个人中心</h4><strong class="logo_icon">  </strong> <span class="logo-default">  </span> </a> </div>
        ...
        <div class="content-bar"> 
          ...
          <div class="row"> 
       		<div class="user-panel">
                ...
                <img class="img-circle mCS_img_loaded" onclick="houseImgOne(this)" name="house_img_one" id="house_img_one" src="{{asset(session('user.photo'))}}">
            ...
            <div class="col-lg-12 col-xl-3">
			  ...
			  <ul id="dc_accordion" class="sidebar-menu tree">    		     
        		<li class="menu_sub"> <a href="#"><img src="{{asset('resources/views/admin/style/img/report.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;"><span>评教</span> <span class="ti ti-angle-down styleicon"></span></a>
                  <ul class="down_menu">
                ...
                <hr >
			      <li> <a href="{{url('admin/sinfo')}}"> <img src="{{asset('resources/views/admin/style/img/info.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;">简介 </span><span class="ion ion-ios-arrow-forward styleicon"></span></a> </li>
			      ...
			      <li> <a href="{{url('admin/spass')}}"><img src="{{asset('resources/views/admin/style/img/set.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;">修改密码</span><span class="ion ion-ios-arrow-forward styleicon"></span></a> </li>
...
function ajaxFileUpload() {
    ...
    (
            {
            	type:"post",
                url: "{{url('admin/supImg')}}", //用于文件上传的服务器端请求地址
