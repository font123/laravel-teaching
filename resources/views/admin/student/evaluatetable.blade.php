...
<div id="dvLoading"></div>
	<form action="{{url('admin/sresult')}}" method="post">
				 {{csrf_field()}}
	         ...
	         <div class="row footer-bottom">
	             <div style="display: inline-block;" >
	             	<div style="margin-top:10px;margin-left:15px;">
	             		<a href="{{url('admin/sevaluate')}}"><span class="iconfont icon-fanhui" style="font-size: 30px;color: #000;"></span></a>
	             	</div>
	             </div>
	            <div style="display: inline-block;margin-left: 45px;">
	            	<ul class="">
	            		  <div style="font-size: 24px;">学生评教</div>
	            	</ul>
	            </div>
	            <div style="display: inline-block;margin-left: 15px;" >
                 ...
                 <input type="hidden" value="" name="act_time" id="time">
                  <input type="hidden" value="{{$art->Scourse_college}}" name="college">
                <input type="hidden" value="{{$art->Scourse_time}}" name="time">
                <input type="hidden" value="{{$art->Scourse_place}}" name="place">
                <input type="hidden" value="{{$art->teacher_id}}" name="teacher_id">
                <input type="hidden" value="{{$art->Scourse_term}}" name="term">
	...
	<div class="row"  style="text-align: center;margin-top: 5%;">
	    ...
	    <div class="sample" >
	    	<span style="color: #0069d9;" >教师:</span><input type="text" readonly="readonly" name="teacher" value="{{$art->Scourse_teacher}}" style="width: 60px;">	          	 
    	  <span style="color: #0069d9" class="course">课程：</span><input type="text" readonly="readonly" name="course" value="{{$art->Scourse_name}}" style="width: 100px;">			 
    	  </div>
	</div>
	</div>
 ...
 <div class="container">
   ...
   <div class="panel-group" id="accordion" style="width: 100%;">
	...
	<div class="row subtn">
	   ...
	   <button type="button" class="btn btn-default btn-lg" id="protected">保存</button>
	</div>
