      ...
      <div class="container_header phone_view border_top_bott">
        <div class="row">
          <div class="col-md-12 d-flex justify-content-between align-items-center">
       		<div class="" style="margin-left: 10px;"> <a href="{{url('admin/sperson')}}" ><img src="{{asset('resources/views/admin/style/img/back.png')}}" ></a> </div>
        ...
        <div class="content-bar"> 
          <div class="row"> 
            ...
            @foreach($data as $val)
			  ...
			  <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">用户名</span> <p contentEditable="true"  style="float: right;"><b>{{$val->student_name}}</b></p> </a>
			  </li>
			  <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">ID</span> <p contentEditable="true"   style="float: right;"><b>{{$val->student_id}}</b></p>   </a>
			  </li>
			    <li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">所属学院</span><p  contentEditable="true"  style="float: right;"><b>{{$val->student_college}}</b></p>  </a>
			    </li>
				<li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">身份</span><p   contentEditable="true"  style="float: right;"><b>学生</b></p> </a>
				</li> 
				<li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">专业</span><p contentEditable="true"  style="float: right;"><b>{{$val->student_major}}</b></p> </a>
				</li>
				<li class="menu_sub"> <a href="#"> <span style="color: #6C757D;">班级</span><p contentEditable="true"  style="float: right;"><b>{{$val->student_class}}</b></p> </a>
				</li>
			  </ul>
			  @endforeach
            </div>
