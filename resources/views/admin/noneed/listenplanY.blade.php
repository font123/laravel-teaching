...
<html>
   ...
   <body>
	  ...
	  <div class="inpu" >
	  <p>
	     <button type="button" class="btn btn-primary btn-lg" style="width: 180px; background-color: #b48bb5;">未完成</button>
		 <a href="{{url('admin/nplan')}}"><button type="button" class="btn btn-primary btn-lg" style="width: 180px; background-color: #76bbd8;">已完成</button></a>
	  </p>
	    </div>
