            ...
            <div class="col-lg-12 col-xl-3">
			  ...
			  <ul id="dc_accordion" class="sidebar-menu tree">
			    ...
			    <li class="menu_sub"> <a href="#"><img src="{{asset('resources/views/admin/style/img/listen.png')}}" style="padding-bottom: 4px;"><span>听课计划</span> <span class="ti ti-angle-down styleicon"></span> </a>
			      <ul class="down_menu">
			        <li><a href="{{url('admin/dyes')}}">已完成</a></li>
			        <li><a href="{{url('admin/dno')}}">未完成</a></li>
			      </ul>
			    </li>
		   		
			    <hr >
			      <li> <a href="{{url('admin/dinfo')}}"><img src="{{asset('resources/views/admin/style/img/info.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;">简介 </span><span class="ion ion-ios-arrow-forward styleicon"></span></a> </li>
				 ...
				 <li> <a href="{{url('admin/dpass')}}"><img src="{{asset('resources/views/admin/style/img/set.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;"></span>修改密码<span class="ion ion-ios-arrow-forward styleicon"></span></a> </li>			     
			      <li> <a href="{{url('admin/logout')}}"><img src="{{asset('resources/views/admin/style/img/out.png')}}" style="padding-bottom: 2px;"><span style="padding-left:5px;"></span>退出登录<span class="ion ion-ios-arrow-forward styleicon"></span> </a> </li>
...
function ajaxFileUpload() {
    ...
    (
            {
            	type:"post",
                url: "{{url('admin/dupImg')}}", //用于文件上传的服务器端请求地址
