      ...
      <div class="container_header phone_view border_top_bott">
        <div class="row">
          <div class="col-md-12 d-flex justify-content-between align-items-center">
            ...
            <div class="logo d-flex align-items-center"><h4 style="margin-top: 10px;margin-left: 35px;">待评教</h4></div>
		  ...
		  <div class="row">
			  ...
			  <div class="col-md-6 col-lg-6 col-xl-3">
			    <div class="card text-white bg-primary m-b-30">
			      <div class="card-header">{{session('user.dudao_name')}}（教师）</div>
			      <div class="card-body">
			    ...
			    <div class="card m-b-30">
			      ...
			      <div class="card-body">
					...
					<div class="row align-items-center no-gutters">
					  ...
					  <div class="col-4 text-right"><img src="{{asset('resources/views/admin/style/img/eval.png')}}" style="width: 120px;"></span> </div>
					</div>
			       
			         <a href="{{url('admin/dtable/'.$val['id'].'/edit')}}"><button type="button" class="btn btn-primary"><i class="feather icon-send mr-2"></i>评教</button></a>
			         </div>
...
<footer class="am-menu am-cf" >
	<a href="{{url('admin/dlisten')}}"><button type="button" class="btn btn-primary btn-lg btn-block">返回</button></a>
</footer>
