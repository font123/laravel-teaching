...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; <a href="{{url('admin/category')}}">分类管理</a> &raquo; 修改分类
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                @foreach($class_tree as $cate)
                                 @if($cate['cate_id']==$cate_info['cate_pid'])
                    ...
                    <tr>
                        <th>关键字：</th>
                        <td>
                            <input type="text" class="sm" name="cate_keywords" value="{{$cate_info['cate_keywords']}}">
                        </td>
                    </tr>          
                    <tr>
                        <th>分类描述：</th>
